...
namespace I2C_BH1750
{
  ...
  public partial class MainForm : Form
  {
    ...
    public MainForm()
    {
      ...
      I2C.Enable();
      I2C.WriteBytes(BH1750_ADDRESS, BH1750_POWER_ON);
      I2C.WriteBytes(BH1750_ADDRESS, Continuously_H_ResolutionMode2);
    ...
    private void OnTick(object sender, EventArgs e)
    {
      ...
      ushort rawBrightness = I2C.Read2Bytes(BH1750_ADDRESS);
    ...
    private void OnFormClosingEvent(Object sender, FormClosingEventArgs e)
    {
      ...
      if (I2C != null)
      {
        I2C.WriteBytes(BH1750_ADDRESS, BH1750_RESET);
        I2C.WriteBytes(BH1750_ADDRESS, BH1750_POWER_DOWN);
        I2C.Disable();
      }
