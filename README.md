...
Download [FastIOW.dll](https://github.com/Tederean/FastIOW/releases/download/V1.1/FastIOW.dll) and [FastIOW.xml](https://github.com/Tederean/FastIOW/releases/download/V1.1/FastIOW.xml). This library requires iowkit.dll in version 1.5, that is part of the official SDK, you can download it [here](https://www.codemercs.com/downloads/iowarrior/IO-Warrior_SDK_win.zip) - extract the following file "/sdk/iowkit api/x64 dll/iowkit.dll".
